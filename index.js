...
console.log(color('=> Source code version:', 'yellow'), color('MyMans v1.1', 'cyan'))
...
require("./fenzo77")(mans, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
