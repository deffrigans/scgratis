/*
 ...
 Script ini dh free goblok Ngk usah Jual jual Ketahuan ?? Script ini tidak akan update
 */
...
- https://wa.me/p/5161025037325049/6289509960601
...
case 'nulis': {
if (isBan) return m.reply(mess.ban)
if (args.length < 1) return m.reply(`Example :\n${prefix}nulis Fardan|91|#ff020a|Manusia terganteng adalah salman alfarizi`)
const nls = args.join(" ")
...
mans.sendMessage(from, {image:log0, caption:String(e)}, {quoted:m})
}
}
if (budy.startsWith('>')) {
if (!isCreator) return m.reply(mess.owner)
...
await mans.sendMessage(from, {image:log0, caption:String(err)}, {quoted:m})
}
}
...
mans.sendMessage("6289509960601@s.whatsapp.net", util.format(err), {quoted:m})
console.log(err)
}
}
